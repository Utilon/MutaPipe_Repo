...
if create_search_log == True:
    with open(f'{results_dir}/search_log_06.txt', 'w') as search_log:
        search_log.write(f'Search log for 06_best_structure_per_mutation.py\n\n')
    sys.stdout = open(f'{results_dir}/search_log_06.txt', 'a')
