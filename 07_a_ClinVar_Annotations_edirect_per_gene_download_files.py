...
#         tree = ET.parse(f'10_ClinVar_{gene}_data_batch_{batch_counter}_of_{math.ceil(len(identifiers)/250)}.xml')
#         root = tree.getroot()
# 
...
#                 with open(f'{results_dir}/10_ClinVar_Annotations_genes_no_data_retrieved.txt', 'w') as file:
...
# 
# # implement this ASAP!!!!!!! --> in separate script!
...
print('   o      10_ClinVar_Annotations_genes_no_data_retrieved.txt       (lists all genes for which no ClinVar annotations could be retrieved)\n\n')
