...
o The best structures for all sequences with only a single amino acid change (compared to canonical sequence) are listed in `06_best_structure_per_point_mutation.csv`
o The best structures for all unique sequences in the PDB associated with the input genes are listed in `06_best_structure_all_unique_combinations.csv`
o The best structures for any available variant in the PDB regardless of other variants in the same structure are listed in `06_best_structure_any_mutation.csv`
...
o The best structures for all sequences with only a single amino acid change (compared to canonical sequence) are listed in `08_best_structure_per_point_mutation.csv`
o The best structures for all unique sequences in the PDB associated with the input genes are listed in `08_best_structure_all_unique_combinations.csv`
o The best structures for any available variant in the PDB regardless of other variants in the same structure are listed in `08_best_structure_any_mutation.csv`
