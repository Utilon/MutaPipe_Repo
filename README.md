...
| [01](https://github.com/Utilon/Pipeline_Git/blob/main/MutaPipe/01_download_files.py)                                     | `ast`<br>`Biopython*`<br>`requests*`                                         | Internet access (PDB API)                             |
...
| [05](https://github.com/Utilon/Pipeline_Git/blob/main/MutaPipe/05_blast_against_reference.py)                            | `Biopython*`<br>`numpy`<br>`re`                                              | UniProt Reference Proteome (fasta)<br><br>NCBI BLAST+ |
