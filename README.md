...
Figure 3.*Output generated by MutaPipe* a) *looking at the content in `Results`* b) *looking at the content in subdirectories `ClinVar_Annotations`, `RefSeqs`, and `NEK1_2structures`. Note: MutPipe's main output files and gene-specific output files are highlighted in yellow in 3a. and 3b., respectively.*
